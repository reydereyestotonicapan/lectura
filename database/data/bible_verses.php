...
/*
 * Verses per chapter for the 66-book Protestant Bible, keyed by the Spanish
 * book names used in App\Models\DayChapter::BIBLE_BOOK_CODES.
 *
 * Each value is a 0-indexed list of verse counts (index 0 => chapter 1).
 * Source: standard Protestant (KJV) versification.
 *
 * NOTE: TLA (Traducción en Lenguaje Actual) occasionally merges adjacent
 * verses, so a verse range derived from these counts always opens the correct
 * chapter/passage but may highlight a verse or two beyond the requested
 * endpoint at a merge boundary. Chapter divisions are always accurate.
 */
